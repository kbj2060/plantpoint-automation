...
(2, '2', '1', true),    -- waterspray
(3, '60', '60', true);  -- fan

-- 4. range_automation 테이블에 데이터 삽입 (컬럼명 수정)
...
(4, 25, 1, false),  -- airconditioner
(5, 7, 1, false);   -- ph

-- 7. environment_logs 테이블에 데이터 삽입
